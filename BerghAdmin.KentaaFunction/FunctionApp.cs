...
public class FunctionApp
{
    ...
    public async Task ReadUsers([TimerTrigger("%cron-users%", RunOnStartup = false)] TimerInfo myTimer)
    {
    ...
    public async Task ReadProjects([TimerTrigger("%cron-projects%", RunOnStartup = true)] TimerInfo myTimer)
    {
    ...
    public async Task ReadActions([TimerTrigger("%cron-actions%", RunOnStartup = false)] TimerInfo myTimer)
    {
    ...
    public async Task ReadDonations([TimerTrigger("%cron-donations%", RunOnStartup = false)] TimerInfo myTimer)
    {
